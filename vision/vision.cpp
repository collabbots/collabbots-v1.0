...
void Vision::start_capture(const camera_code& camera)
{
    ...
    switch (camera)
    {
        ...
        case camera_code::SIDE_VIEW:
            side_view = cv::VideoCapture(1);
